      ...
      >
        ...
        <div className="backdrop-blur-xl bg-white/[0.02] border border-white/[0.05] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] rounded-[2rem] p-8 md:p-10 relative overflow-hidden">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/25 ring-1 ring-white/10">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-slate-400">Enter your details to access your unified inbox.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); onNavigate('dashboard');}}>
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-white/[0.03] border border-white/[0.08] text-white rounded-xl px-4 py-3 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  type="password" 
                  placeholder="••••••••" 
                  className="w-full bg-white/[0.03] border border-white/[0.08] text-white rounded-xl px-4 py-3 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all font-mono tracking-widest text-lg h-[50px]"
                  required
                />
              </div>
            </div>
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.99 }}
              type="submit"
              className="w-full bg-white text-slate-900 font-semibold rounded-xl py-3.5 mt-2 hover:bg-slate-100 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.1)] flex items-center justify-center gap-2"
            >
              Sign In
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-[#0e1320] px-2 text-slate-500 tracking-wider">OR CONTINUE WITH</span>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-3 mt-6">
              <button className="flex items-center justify-center gap-2 bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] rounded-xl py-2.5 transition-all">
        ...
        <div className="mt-6 text-center text-sm text-slate-500">
          ...
          <button onClick={() => onNavigate('signup')} className="text-white hover:text-indigo-400 font-medium transition-colors">
            Sign up
          </button>
        </div>
      </motion.div>
